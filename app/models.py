...
class User(db.Model, UserMixin):
    ...
    results_list     = db.Column(ARRAY(db.String))
    results_cc_list  = db.Column(ARRAY(db.String))
    invoice_list     = db.Column(ARRAY(db.String))
    invoice_cc_list  = db.Column(ARRAY(db.String))
